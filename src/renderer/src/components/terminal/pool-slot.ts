 ...
 * one THIS surface is not already showing, which makes detaching a middle tab
 * and pressing `+` reuse that slot (and, if a phone still has it open,
 * re-attach to the very same shell) rather than pile up a new one at the end.
 *
