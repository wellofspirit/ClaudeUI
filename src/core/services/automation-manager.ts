...
export class AutomationManager {
  ...
  /**
   * Native-notification sink. The desktop shell wires Electron's `Notification`
   * here (see `ipc/automation.ipc.ts`); a headless deployment leaves it unset
   * and no native notification is emitted — there is no desktop to notify.
   */
  constructor(private readonly notifier?: HostNotifier) {}
