...
let hostWindow: HostWindowHandle | null = null
 ...
 */
export function setHostWindow(win: HostWindowHandle | null): void {
  hostWindow = win
}

/** The host's primary window, or `null` when the app runs windowless. */
export function getHostWindow(): HostWindowHandle | null {
  return hostWindow
}
