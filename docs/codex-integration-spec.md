...
- **Interrupted-tool presentation supplement.** Pinned, not built (`cf11b983`, 2026-09-13): an interrupted dynamic-tool call is absent from the turn's items in native history, and the live card ends without a result. Whether to synthesize a failed result live and/or persist a supplement is Daniel's decision.
