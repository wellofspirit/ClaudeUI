...
**Supersedes in part:** ADR-039 (auth _methods & policy_ layer; its transport hardening — Host allowlist, throttling, funnel reject, identity-header trust predicate — carries forward unchanged)
