...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CodexSession extends BaseSession` | One root session's lifecycle, model and effort selection, per-turn policy derivation and approval gating. Owns a THREAD on its account's host (ADR-069 §2), never a process: `dispose()` interrupts the running turn, closes its children's cards and detaches. Held queue and steer, hosted tools, dispatch as a source, completed-turn fork and native children are built; full usage is planned |
