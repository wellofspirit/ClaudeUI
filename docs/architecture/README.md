...
| [codex.md](codex.md)                 | M1a transport foundation as built, plus planned fourth-engine session integration: native approvals/auth, history/queue/tools and release gates under ADR-066                                       |
