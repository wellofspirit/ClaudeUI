...
- [architecture.md](architecture.md) — how the app is put together: process model, source layout, main-process services, the multi-engine seam (engines/vendors/accounts, capabilities, opencode backend, cross-engine dispatch), IPC & data flow, persistence model, settings/config planes, UI gotchas. **Start here for any structural question.**
