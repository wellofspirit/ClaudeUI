...
- [protocol/](protocol/README.md) — the cli.js wire manual: every stream-json message, control subtype, CLI flag, MCP hosting, cancellation, the extract→patch→rebundle build pipeline (01-transport §1.12) and patch registry. **Authoritative — consult before theorizing about cli.js behavior or touching `src/core/sdk/` / `patch/`.**
